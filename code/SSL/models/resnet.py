...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("out_pool.size: ", out_pool.size())
        out_cnn = out_pool.view(out_pool.size(0), -1)
        out = self.linear(out_cnn)

        return out, [out1, out2, out3, out4] #original

        #return out, out_pool.view(out_pool.size(0), -1) #for Coreset_in_only
        # return out, out4 #, out_cnn #for OURS
        # return out, out_cnn  # , out_cnn #for OURS
