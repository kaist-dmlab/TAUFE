...
# Place365 (ood)
folder = '/data/pdm102207/places365/places365_standard/'
...
def train(models, criterion, optimizers, schedulers, dataloaders, num_epochs, weight):
    ...
    #np.savetxt('../logs_sup/Imgnet224_10_990_Blackhole_n5000_per_epoch_v2.txt',logs, delimiter=',', fmt="%.4f")
    print('>> Finished.')
...
'''
#save as pickle
with open('../data/Imgnet224/imgnet224_train_in_v2.txt', 'wb') as f:
    pickle.dump(imgnet224_train_in, f)
with open('../data/Imgnet224/imgnet224_train_ood_v1_new.txt', 'wb') as f:
    pickle.dump(imgnet224_train_ood, f)
with open('../data/Imgnet224/imgnet224_test_v2.txt', 'wb') as f:
...
'''
train_in, train_ood = imgnet224_train_in, imgnet224_train_ood #imgnet64_train_ood # cifar100_train
test_in, test_ood = imgnet224_test, place365_train_ood
...
if __name__ == '__main__':
    ...
    #print(len(indices_ood))
    labeled_set_ood = indices_ood[:len(labeled_set_in)]
