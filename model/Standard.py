...
def train(models, criterion, optimizers, schedulers, dataloaders, num_epochs):
    ...
    np.savetxt('../logs_rebuttal/cifar100_80mTiny_standard_v1.txt', logs, delimiter=',', fmt="%.4f")
    print('>> Finished.')
#
...
if __name__ == '__main__':
    ...
    print("# labeled_set_in: {}, # labeled_set_ood: {}, # test_in: {}".format(len(labeled_set_in), len(labeled_set_ood), len(test_in)))
    ...
    #acc, auroc, aupr, fpr = test_new(models, dataloaders)
